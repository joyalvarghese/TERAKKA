...
import com.aumento.onlinecabdriver.Adapter.SelectCountryCodeRecycleAdapter;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void registerPhone() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://"+ip+"/cab_booking/API/driverLogin.php", new Response.Listener<String>() {
            @Override
